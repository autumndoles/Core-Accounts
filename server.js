...
async function initializeDatabase() {
    ...
    try {
        ...
        */
        ...
        API tokens are used by external
        Core Games applications.
...
/*
Get account from browser session.
*/
...
/*
Create an API token for an account.
*/
...
/*
Get account from API Bearer token.
...
app.post(
    ...
    async (req, res) => {
        ...
        try {
            ...
            /*
            The user must already be logged
            into Core Games Accounts.
            */
